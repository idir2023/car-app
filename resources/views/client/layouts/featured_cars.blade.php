            ...
            <div class="row">
                    ...
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc1.png' }}" alt="cars">
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc2.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc3.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc4.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc5.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc7.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{ 'assets_client/images/featured-cars/fc8.png' }}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
